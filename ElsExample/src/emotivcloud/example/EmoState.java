...
public interface EmoState extends Library {
	...
	public enum EE_InputChannels_t {
		EE_CHAN_CMS, EE_CHAN_DRL, EE_CHAN_FP1, EE_CHAN_AF3, EE_CHAN_F7, EE_CHAN_F3, 
		EE_CHAN_FC5, EE_CHAN_T7, EE_CHAN_P7, EE_CHAN_O1, EE_CHAN_O2, EE_CHAN_P8, 
		EE_CHAN_T8, EE_CHAN_FC6, EE_CHAN_F4, EE_CHAN_F8, EE_CHAN_AF4, EE_CHAN_FP2
	}
	 ...
	 * 
	 * \param state - \param leftEye - the left eyelid state (0.0 to 1.0) \param
	...
	/*
	 * ! \param state - rawScore - return raw score minScale, maxScale - return
	 * scale range \sa ES_AffectivGetExcitementShortTermModelParams
	 */
	void ES_AffectivGetExcitementShortTermModelParams(Pointer state,
			DoubleByReference rawScore, DoubleByReference minScale,
			DoubleByReference maxScale);

	// ! Returns Meditation model parameters
	/*
	 * ! \param state - rawScore - return raw score minScale, maxScale - return
	 * scale range \sa ES_AffectivGetMeditationModelParams
	 */
	void ES_AffectivGetMeditationModelParams(Pointer state,
			DoubleByReference rawScore, DoubleByReference minScale,
			DoubleByReference maxScale);
	...
	/*
	 * ! \param state - rawScore - return raw score minScale, maxScale - return
	 * scale range \sa ES_AffectivGetEngagementBoredomModelParams
	 */
	void ES_AffectivGetEngagementBoredomModelParams(Pointer state,
			DoubleByReference rawScore, DoubleByReference minScale,
			DoubleByReference maxScale);
	...
	/*
	 * ! \param state - rawScore - return raw score minScale, maxScale - return
	 * scale range \sa ES_AffectivGetFrustrationModelParams
	 */
	void ES_AffectivGetFrustrationModelParams(Pointer state,
			DoubleByReference rawScore, DoubleByReference minScale,
			DoubleByReference maxScale);
	...
	/*
	 * ! \param state - rawScore - return raw score minScale, maxScale - return
	 * scale range \sa ES_AffectivGetValenceModelParams
	 */
	void ES_AffectivGetValenceModelParams(Pointer state,
			DoubleByReference rawScore, DoubleByReference minScale,
			DoubleByReference maxScale);
}