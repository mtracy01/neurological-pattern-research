...
public interface Edk extends Library {
	...
	public enum EE_ExpressivTrainingControl_t {
		EXP_NONE(0), EXP_START(1), EXP_ACCEPT(2), EXP_REJECT(3), EXP_ERASE(4), EXP_RESET(
				5);
		private int type;
	...
	public enum EE_CognitivTrainingControl_t {
		COG_NONE(0), COG_START(1), COG_ACCEPT(2), COG_REJECT(3), COG_ERASE(4), COG_RESET(
				5);
	...
	public enum EE_CognitivEvent_t {
		EE_CognitivNoEvent(0), EE_CognitivTrainingStarted(1), EE_CognitivTrainingSucceeded(
				2), EE_CognitivTrainingFailed(3), EE_CognitivTrainingCompleted(
				4), EE_CognitivTrainingDataErased(5), EE_CognitivTrainingRejected(
				6), EE_CognitivTrainingReset(7), EE_CognitivAutoSamplingNeutralCompleted(
